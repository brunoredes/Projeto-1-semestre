...
const cfg = {
    "host": "setion.database.windows.net", // server name do banco de dados
    "user": "bandtec", // login ("bandtec")
    "pass": "Setion@5", // senha do banco de dados
    "db": "Setion" // nome da base de dados
};
...
function registrarLeitura(temperatura, umidade) {
	...
	request = new Request(`
	INSERT into Dado (vlrTemperatura, vlrUmidade, dtDia, arduino) 
	values (@temperatura, @umidade, CURRENT_TIMESTAMP, 2);
	`, function(err, linhas) {  
		 if (err) {  
